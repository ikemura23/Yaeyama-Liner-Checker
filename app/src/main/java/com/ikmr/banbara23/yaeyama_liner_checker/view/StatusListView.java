...
public class StatusListView extends FrameLayout {
    ...
    // @Bind(R.id.view_status_list_status_icon_image)
...
//    int colorSuspend;
    ...
    // mStatusIconText = (TextView)
    // findViewById(R.id.view_status_list_status_icon_text);
    // mDescriptionText = (TextView)
    // findViewById(R.id.view_status_list_description_text);
    // }
